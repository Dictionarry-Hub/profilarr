			...
			return {
				...
				mediaInfo: movieFile?.mediaInfo
					? {
							...
							videoDynamicRange: movieFile.mediaInfo.videoDynamicRange,
							videoDynamicRangeType: movieFile.mediaInfo.videoDynamicRangeType,
							resolution: movieFile.mediaInfo.resolution,
							subtitles: movieFile.mediaInfo.subtitles
						}
					: undefined,
				scoreBreakdown,
				cutoffScore,
