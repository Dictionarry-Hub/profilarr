...
| Form        | `FormInput.svelte`, `NumberInput.svelte`, `IconCheckbox.svelte`, `MarkdownInput.svelte`, `TagInput.svelte`                                                                                    |
| Label       | `Label.svelte`                                                                                                                                                                                |
...
- **Form:** `DateInput.svelte`, `TimeInput.svelte`, `KeyValueList.svelte`,
  `RangeScale.svelte`, `CodeInput.svelte`, `SearchDropdown.svelte`
...
| Roswell       | light | `.theme-roswell`      | Pixies' Trompe le Monde (#f8f6fc), lavender-white facility, electric violet accent, clean geometric shadows, smooth radius (12px cards, 8px controls), Outfit / Space Mono |
| Larbalestier  | dark  | `.theme-larbalestier` | Pixies' Doolittle (#110e0c), deep espresso studio, burnt amber accent, warm close shadows, tight radius (8px cards, 6px controls), Archivo / Space Mono                    |
